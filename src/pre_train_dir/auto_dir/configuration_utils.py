...
class PretrainedConfig(object):
    r""" Base class for all configuration classes.
        Handles a few parameters common to all scAuto' configurations as well as methods for loading/downloading/saving configurations.
        ...
        Args:
            ...
            torchscript (:obj:`bool`, `optional`, defaults to :obj:`False`):
                Is the model used with Torchscript (for PyTorch scAuto).
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.output_past = kwargs.pop("output_past", True)  # Not used by all scAuto
        self.torchscript = kwargs.pop("torchscript", False)  # Only used by PyTorch scAuto
        self.use_bfloat16 = kwargs.pop("use_bfloat16", False)
        self.pruned_heads = kwargs.pop("pruned_heads", {})

        # Is decoder is used in encoder-decoder scAuto to differentiate encoder from decoder
